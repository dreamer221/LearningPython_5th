...
and see pybench_cases.py for usage details.
"""

import pybench, sys

pythons = [            # format=(ispy3?, exepath)
    (1, r'D:\software\anaconda202105\python'),
    (0, r'D:\software\python27\python'),
    (0, r'D:\software\python33\python')
]
...
# Files: close() else may fail in pypy due to number of open files
    (0, 0, "f=open(r'D:/software/anaconda202105/Lib/pdb.py')\nfor line in f: x=line\nf.close()"),
